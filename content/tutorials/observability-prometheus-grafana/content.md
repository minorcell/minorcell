...
<!-- step-image src=/images/tutorials/observability-prometheus-grafana/architecture.svg alt=Prometheus 监控架构：Go 服务暴露 /metrics，Prometheus 定期拉取并存储时序数据，Grafana 通过 PromQL 查询展示 -->
