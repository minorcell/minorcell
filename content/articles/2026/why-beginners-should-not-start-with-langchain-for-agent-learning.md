...
keywords: [Agent学习, LangChain, 初学者, AI框架, Agent开发]
order: 48
---
...
这件事很像前端和后端的学习路径——无论上层框架怎么变，真正决定上限的始终是底层基础能力。Agent 框架把门槛降得很低，接个模型配几个工具，Demo 很快就能跑通。但能跑通不代表你真的理解了。

一旦进入真实业务，工具鉴权、中间状态可审计、模型决策兜底、失败重试还是中断——这些问题框架可以给你通用外壳，但不可能替你填好具体业务里的东西。
