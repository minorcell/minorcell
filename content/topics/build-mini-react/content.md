...
```jsx step file=steps/03.jsx highlight=25,28,29,30
...
```jsx step file=steps/10.jsx highlight=25,38:40,43
...
```jsx step file=steps/11.jsx highlight=47,55,56,58
...
```jsx step file=steps/11.jsx highlight=47,48,49,53,54,56
...
```jsx step file=steps/11.jsx highlight=45,47,50:52,56,60:62
...
<!-- step-image src=/fiber0.png alt=Fiber Tree 0 -->
...
<!-- step-image src=/fiber1.png alt=Fiber Tree 1 -->
...
<!-- step-image src=/fiber2.png alt=Fiber Tree 2 -->
...
<!-- step-image src=/fiber3.png alt=Fiber Tree 3 -->
...
<!-- step-image src=/fiber4.png alt=Fiber Tree 4 -->
...
```jsx step file=steps/15.jsx

```

Then for each child we create a new fiber.

```jsx step file=steps/16.jsx
...
```jsx step file=steps/17.jsx highlight=65:108

```

And that's our `performUnitOfWork`.

```jsx step file=steps/17.jsx highlight=65,70:72
...
```jsx step file=steps/20.jsx highlight=41:54
...
```jsx step file=steps/21.jsx highlight=41,43,45,57,58,63,64,66,69
...
```jsx step file=steps/21.jsx highlight=90:129

```

Now let's extract the code from `performUnitOfWork` that creates the new fibers...

```jsx step file=steps/22.jsx highlight=90,95,96,108,110,114

```

...to a new `reconcileChildren` function.

```jsx step file=steps/22.jsx highlight=110,133

```

Here we will reconcile the old fibers with the new elements.

```jsx step file=steps/23.jsx highlight=110:113,116:120,123
...
```jsx step file=steps/25.jsx highlight=123:137
...
```jsx step file=steps/38.jsx highlight=245:251
...
```jsx step file=steps/38.jsx highlight=162:168
...
```jsx step file=steps/42.jsx highlight=99:125
...
```jsx step file=steps/46.jsx highlight=195,196,198:202

```

Here is where we call the `Counter` function from the example. And inside that function we call `useState`.

```jsx step file=steps/47.jsx highlight=195:201,202,204
...
```jsx step file=steps/48.jsx highlight=206:218
...
```jsx step file=steps/49.jsx highlight=211,213:225,229
...
```jsx step file=steps/50.jsx highlight=1:319
