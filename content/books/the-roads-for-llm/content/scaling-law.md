...
不过，"涌现能力"这个概念本身也在学术界的审视之中。2023 年，Schaeffer 等人在一篇引发广泛讨论的论文中指出：许多被报告为"涌现"的现象，可能与评估指标的选择有关。当使用非线性或离散的评测指标（如精确匹配准确率）时，能力提升在跨越阈值时看起来像"突然出现"；但如果换成连续的评测指标（如 Brier score 或 perplexity），同样的能力提升往往呈现为平滑的 Scaling 曲线。换句话说，部分"涌现"可能来自度量方式的不连续性，而非模型能力的真正突变。这场争论仍在进行中——但不论最终结论如何，它提醒我们：大规模模型的真实行为比单一的"涌现叙事"更复杂。
...
下一步——卷四——你将看到这些发动机装上燃料起飞后的世界：ChatGPT、RLHF、LoRA、RAG、Agent、多模态，一直到 AI 安全和未来。
