...
.sm-scope .staggered-menu-wrapper[data-has-logo='false'] .staggered-menu-header { justify-content: flex-end; }
...
@media (max-width: 1024px) {
  ...
  .sm-scope .staggered-menu-panel { width: 100%; left: 0; right: 0; padding: 5.5rem 1.25rem 1.5rem; }
  .sm-scope .sm-prelayers { width: 100%; left: 0; right: 0; }
  .sm-scope .sm-panel-item { font-size: clamp(2rem, 11vw, 3.2rem); letter-spacing: -1px; padding-right: 1.2em; }
  .sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { right: 2.4em; font-size: 14px; }
  .sm-scope .sm-socials-link { font-size: 1rem; }
  .sm-scope .staggered-menu-wrapper[data-open] .sm-logo-img { filter: invert(100%); }
}
@media (max-width: 640px) {
  .sm-scope .staggered-menu-panel { padding-top: 5rem; }
}
      `}</style>
    </div>
  )
